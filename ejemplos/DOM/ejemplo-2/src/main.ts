const formContent = document.getElementById('form-tarea') as HTMLFormElement;
const inputValue = document.getElementById('input-tarea') as HTMLInputElement;
const btnAddTask = document.getElementById('btn-agregar') as HTMLButtonElement;
const listaAgregados = document.getElementById('list-addTask') as HTMLUListElement;
const listaCompletados = document.getElementById('list-completedTask') as HTMLUListElement;

formContent.addEventListener('submit', agregarTareas)

function agregarTareas(event: SubmitEvent) {
