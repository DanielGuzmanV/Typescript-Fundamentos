...
// 1. Cambiar valores y medir tamaño con .length "Comentar algunso ejemplos para ver los resultados"
...
// C. Vaciar un array instantaneamente (Comentar para no tener problemas)
