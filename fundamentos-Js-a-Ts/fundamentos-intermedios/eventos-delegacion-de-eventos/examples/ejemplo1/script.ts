...
const resultado = document.getElementById('result')  as HTMLParagraphElement;
...
function obtenerColorRandom(): string{
...
document.addEventListener('eventoEspecial', function(evento) {
    const eventoCus = evento as CustomEvent
