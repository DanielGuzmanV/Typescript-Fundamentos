...
function guardarDatosLocal() {
    let claveLocal = document.getElementById('entradaValue1') as HTMLInputElement | null;;
    let valorLocal = document.getElementById('entradaValue2') as HTMLInputElement | null;;

    // Vemos que la clave y valor no esten vacios
    if(claveLocal && valorLocal){
        const clave1: string = claveLocal.value;
        const valor1: string = valorLocal.value;
...
function guardarDatosSession() {
    let claveSession = document.getElementById('entradaValor1') as HTMLInputElement | null
    let valorSession = document.getElementById('entradaValor2') as HTMLInputElement | null

    if(claveSession && valorSession) {
        const clave2: string = claveSession.value;
        const valor2: string = valorSession.value;
