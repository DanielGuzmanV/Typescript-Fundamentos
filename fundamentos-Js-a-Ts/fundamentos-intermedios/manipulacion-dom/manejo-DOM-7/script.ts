...
document.getElementById('mostrarTexto')?.addEventListener('click', () => {
    const labelInputValue = document.getElementById('entrada') as HTMLInputElement | null;
...
document.getElementById('agregarElementos')?.addEventListener('click', () => {
    const nuevosElementos: string = '<li>Nuevo elemento</li>'

    const ulElements = document.getElementById('listaElement') as HTMLElement | null;
